...
/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/js/todo_calendar.js
 */
...
frappe.views.calendar["ToDo"] = {
	...
	get_events_method: "artyfetes.artyfetes.custom_todo.todo.get_events"
}



/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/article_stock_inventory.html
 */
frappe.templates['article_stock_inventory'] = ' <table class="table table-bordered">     <tr>       <td> Actual Stock</td>       <td> {{actual_stock}}</td>     </tr>      <tr>       <td> Sales Order</td>       <td>{{sales_orders}}</td>     </tr>      <tr>       <td> Available Stock</td>       <td>{{available_stock}}</td>     </tr>      <tr>       <td>Suplier Stock</td>       <td>{{supplier_orders}}</td>     </tr>          <tr>       <td> Virtual Stock</td>       <td>{{virtual_stock}}</td>     </tr>   </table>  ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/customer_document.html
 */
frappe.templates['customer_document'] = '<div> <table class="table table-bordered">     <thead>         <tr>             <th >Type</th>             <th >Name</th>             <th >Date</th>             <th >Status</th>             <th >Address</th>             <th >Owner</th>             <th >Grand Total</th>          </tr>     </thead>     <tbody>                  {% for(var i=0, l=data.length; i < l; i++) { %}          <tr>             <td> {%= data[i][__("type")]%} </td>             <td>                 {% if( data[i][__("type")] == "Order"  || data[i][__("type")] == "Order Form") { %}                         <a href= "#Form/Sales Order/{%= encodeURIComponent(data[i].name) %}">                              <b> {%= data[i][__("name")]%} </b>                          </a>                 {% } else { %}                          <a href= "#Form/{%= encodeURIComponent(data[i].type) %}/{%= encodeURIComponent(data[i].name) %}">                              <b> {%= data[i][__("name")]%} </b>                          </a>                  {% } %}                            </td>             <td> {%= data[i][__("transaction_date")]%}</td>             <td> {%= data[i][__("status")]%} </td>             <td> {%= data[i][__("customer_address")]%}</td>             <td> {%= data[i][__("owner")]%}</td>             <td> {%= data[i][__("grand_total")]%}</td>         </tr>         {% } %}     </tbody>   </table>  </div>  ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/documents_button.html
 */
frappe.templates['documents_button'] = '<html> <head> <style type="text/css">   .button {       background-color: #f0f4f7;       border-radius: 3px;       border-color:transparent;     } </style>  </head> <body>     <div class="container">       <div class="row">           <div class="col-sm-12">               <button type="button" id ="all_btn" class="button"> ALL</button>               <button type="button" id ="quotation_btn" class="button"> Quotation</button>               <button type="button" id ="order_form_btn" class="button"> Order Form </button>               <button type="button" id ="order_btn" class="button"> Order</button>               <button type="button" id ="referencing_btn" class="button"> Referencing</button>               <button type="button" id ="sales_invoice_btn" class="button">Invoice</button>               <button type="button" id ="pre_order_btn" class="button"> Pre Order</button>               <button type="button" id ="back_order_btn" class="button"> Back Order</button>               <button type="button" id ="return_form_btn" class="button"> Return Form</button>               <button type="button" id ="credit_note_btn" class="button"> Credit Note</button>               <button type="button" id ="sample_btn" class="button"> Sample</button>             </div>           </div>     </div> </body>   ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/planned_task.html
 */
frappe.templates['planned_task'] = '<div> <table class="table table-bordered">     <thead>         <tr>             <th> Task Id </th>             <th style="width: 220px;"> Customer Contact  </th>             <th style="width: 175px;"> Address </th>             <th style="width: 175px;"> Artyfetes Contact </th>             <th> Start Time </th>             <th> End Time </th>         </tr>     </thead>      <tbody>          {% for(var i=0, l=data.length; i < l; i++) { %}          <tr>              <td>                  <a href= "#Form/Task/{%= encodeURIComponent(data[i].name) %}">                      <b> {%= data[i][__("name")]%}</b>                 </a>             </td>             <td style="width: 220px;">{%= data[i][__("contact_person")]%}</b> </td>             <td style="width: 175px;">{%= data[i][__("customer_address")]%} </td>             <td style="width: 175px;"> {%= data[i][__("artyfetes_contact")]%} </td>             <td> {%= data[i][__("start_time")]%}</td>              <td> {%= data[i][__("end_time")]%}</td>         </tr>         {% } %}          </tbody>  </table>  </div>  ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/purchase_summary.html
 */
frappe.templates['purchase_summary'] = '<table class="table table-bordered">     <thead>         <tr>             <th> Collection</th>             <th> Order</th>              <th> Product Qty</th>         </tr>     </thead>     <tbody>       {% for(var i=0, l=data.length; i < l; i++) { %}           <tr>             <td> {%= data[i][__("colloection")]%} </td>             <td> {%= data[i][__("order")]%} </td>             <td> {%= data[i][__("purchase_qty")]%} </td>           </tr>        {% } %}           </tbody>  </table>  ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/sales_history.html
 */
frappe.templates['sales_history'] = '<table class="table table-bordered">     <thead>         <tr>             <th>Date</th>             <th>Qty Sold</th>             <th>Qty Customer</th>             <th>Turnover</th>             <th>Margin</th>             <th>% Margin</th>         </tr>     </thead>     <tbody>       {% for(var i=0, l=data.length; i < l; i++) { %}           <tr>             <td> {%= data[i][__("date")]%} </td>             <td> {%= data[i][__("total_qty")]%} </td>             <td> {%= data[i][__("total_cust")]%} </td>             <td> {%= data[i][__("total_amt")]%} </td>             <td> {%= data[i][__("total_margin")]%} </td>             <td> {%= data[i][__("margin_percentage")]%} </td>           </tr>        {% } %}           </tbody>  </table> ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/map_view.html
 */
frappe.templates['map_view'] = '<link rel="stylesheet" href="http://cdn.leafletjs.com/leaflet/v0.7.7/leaflet.css" /> <link rel="stylesheet" href="https://unpkg.com/leaflet@1.0.1/dist/leaflet.css" /> <script src="http://cdn.leafletjs.com/leaflet/v0.7.7/leaflet.js"></script>  <div id="mapid">  <div class="text-muted not_found">   Unable to find Map based on address entered.<br>   Please enter latitude, longitude.  </div> </div> <style>  #mapid {   width: 600px;   height: 400px;   z-index: 1;   border: 1px solid rgba(0, 0, 0, 0.18);  }  .not_found {   text-align: center;   padding: 100px;  } </style>';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/map_template.html
 */
frappe.templates['map_template'] = '<html>   <head>   <style>        #map {         height: 500px;         width: 500px;        }     </style>      <script async defer     src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAByxJyFtKW-x8IFdq2SdLZP5YB6syM0J8&callback=initMap">     </script>            </head>   <body>    <input type="hidden" id="lat" value={{lat}}>    <input type="hidden" id="lon" value={{lon}}>                <div id="map"></div>       </body> </html>';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/rdv_contacts.html
 */
frappe.templates['rdv_contacts'] = '<div> <table class="table table-bordered">     <thead>         <tr>             <th >Contact</th>             <th >Name</th>             <th >Phone</th>         </tr>     </thead>     <tbody>       {% for(var i=0, l=data.length; i < l; i++) { %}         <tr>          <td> {%= data[i][__("contact")]%} </td>          <td> {%= data[i][__("name")]%} </td>          <td> {%= data[i][__("phone")]%} </td>         </tr>        {% } %}           </tbody>  </table>  </div> ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/artyfetes_contact.html
 */
frappe.templates['artyfetes_contact'] = '<div> <table class="table table-bordered">     <thead>         <tr>             <th> Employee</th>             <th> Name</th>         </tr>     </thead>     <tbody>       {% for(var i=0, l=data.length; i < l; i++) { %}           <tr>             <td> {%= data[i][__("employee")]%} </td>             <td> {%= data[i][__("name")]%} </td>           </tr>        {% } %}           </tbody>  </table>  </div> ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/bank_details.html
 */
frappe.templates['bank_details'] = '<table class="table table-bordered">     <thead>         <tr>             <th>Bank Name</th>             <th>IBAN No</th>             <th>Name</th>             <th>Swift</th>         </tr>     </thead>     <tbody>       {% for(var i=0, l=data.length; i < l; i++) { %}           <tr>             <td> {%= data[i][__("bank_name")]%} </td>             <td> {%= data[i][__("iban_no")]%} </td>             <td> {%= data[i][__("name")]%} </td>             <td> {%= data[i][__("swift")]%} </td>           </tr>        {% } %}           </tbody>  </table> ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/bank_details_customer.html
 */
frappe.templates['bank_details_customer'] = '<table class="table table-bordered">     <thead>         <tr>             <th>Bank Name</th>             <th>IBAN No</th>             <th>Name</th>             <th>Swift</th>             <th>Address</th>         </tr>     </thead>     <tbody>       {% for(var i=0, l=data.length; i < l; i++) { %}           <tr>             <td> {%= data[i][__("bank_name")]%} </td>             <td> {%= data[i][__("iban_no")]%} </td>             <td> {%= data[i][__("name")]%} </td>             <td> {%= data[i][__("swift")]%} </td>             <td> {%= data[i][__("bank_address")]%} </td>           </tr>        {% } %}           </tbody>  </table>';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/customer_dashboard.html
 */
frappe.templates['customer_dashboard'] = '<html> <head> <style type="text/css">   .button {       background-color: #f0f4f7;       border-radius: 3px;       border-color:transparent;     } </style>  </head> <body>     <div class="container">       <div class="row">           <div class="col-sm-12">               <button type="button" id ="link_customer" class="button"> Link Customer</button>               <button type="button" id ="login_as_customer" class="button"> Login as a Customer</button>               <button type="button" id ="send_password" class="button">Send Password</button>               <button type="button" id ="reset_and_send" class="button">Reset and Send Password</button>             </div>       </div>     </div> </body>  ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/average_qty_product_order.html
 */
frappe.templates['average_qty_product_order'] = '<table class="table table-bordered">     <thead>         <tr>             <th>Catalog</th>             <th>Order</th>             <th>Qty Ordered</th>             <th>Total</th>             <th>Customer</th>                      </tr>     </thead>     <tbody>       {% for(var i=0, l=data.length; i < l; i++) { %}           <tr>             <td> {%= data[i][__("catalog")]%} </td>             <td> {%= data[i][__("total_order")]%} </td>             <td> {%= data[i][__("qty_ordered")]%} </td>             <td> {%= data[i][__("total_amount")]%} </td>             <td> {%= data[i][__("total_cust")]%} </td>                       </tr>        {% } %}           </tbody>  </table> ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/purchase_history.html
 */
frappe.templates['purchase_history'] = '<table class="table table-bordered">     <thead>         <tr>             <th>Supplier</th>             <th>Price</th>             <th>Qty Ordered</th>             <th>Last Order</th>         </tr>     </thead>     <tbody>       {% for(var i=0, l=data.length; i < l; i++) { %}           <tr>             <td> {%= data[i][__("supplier")]%} </td>             <td> {%= data[i][__("rate")]%} </td>             <td> {%= data[i][__("qty")]%} </td>             <td> {%= data[i][__("date")]%} </td>           </tr>        {% } %}           </tbody>  </table>  ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/quotation_history.html
 */
frappe.templates['quotation_history'] = '<table class="table table-bordered">     <thead>         <tr>             <th>Supplier</th>             <th>Price</th>             <th>MOQ</th>             <th>Last Order</th>         </tr>     </thead>     <tbody>       {% for(var i=0, l=data.length; i < l; i++) { %}           <tr>             <td> {%= data[i][__("customer")]%} </td>             <td> {%= data[i][__("rate")]%} </td>             <td> {%= data[i][__("qty")]%} </td>             <td> {%= data[i][__("date")]%} </td>           </tr>        {% } %}           </tbody>  </table>  ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/contact_dashboard.html
 */
frappe.templates['contact_dashboard'] = '<html> <head> <style type="text/css">   .button {       background-color: #f0f4f7;       border-radius: 3px;       border-color:transparent;     } </style>  </head> <body>     <div class="container">       <div class="row">           <div class="col-sm-4">               <button type="button" id ="login_as_contact" class="button"> Login as a Contact</button>           </div>            <div class="col-sm-3">               <button type="button" id ="send_password" class="button">Send Password</button>           </div>            <div class="col-sm-4">                <button type="button" id ="reset_and_send" class="button">Reset and Send Password</button>             </div>           </div>     </div> </body>  ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/attribute_values_data.html
 */
frappe.templates['attribute_values_data'] = '<div class="container" style="margin-top:18px;">  {% for(var key in data){ %}   <div class="row">    <div class="col-xs-12" id="{%= key %}">     {%= key %}    </div>       </div>    {% for(var val in data[key]) { %}    <div class="row">     <div class="col-xs-12">      {% if(data[key][val] == 0 ){ %}          <input class ="attribute_value" id="{%= val %}" type="checkbox" name="attribute_val"          data-att= "{%= key %}" data-attr-val="{%= val %}" value="{%= val %}">          {%= val %}        {% } %}        {% if(data[key][val] != 0 ){ %}          <input class ="attribute_value" id="{%= val %}" type="checkbox" name="attribute_val"          data-att= "{%= key %}" data-attr-val="{%= val %}" value="{%= val %}" checked="checked">          {%= val %}        {% } %}        </div>    </div>   {% } %}   <br>  {% } %} </div>';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/family.html
 */
frappe.templates['family'] = '<div class="container" style="margin-top:18px;">  {% for(var key in data){ %}   <div class="col-xs-12" >     {% if(data[key] == 0 ){ %}      <div class="form-check form-check-inline">        <input class ="attribute_value" id="{%= key %}" type="checkbox" name="attribute_val"         data-att= "{%= key %}" value="{%= key %}">         {%= key %}       </div>      {% } %}             {% if(data[key] != 0 ){ %}        <input class ="attribute_value" id="{%= key %}" type="checkbox" name="attribute_val"        data-att= "{%= key %}" value="{%= key %}" checked="checked">        {%= key %}      {% } %}    </div>  <br>  {% } %} </div>  ';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/sub_family.html
 */
frappe.templates['sub_family'] = ' <div class="container" style="margin-top:18px;">  {% for(var key in data){ %}   <div class="row">    <div class="col-xs-12" id="{%= key %}">     {%= key %}    </div>       </div>    {% for(var val in data[key]) { %}    <div class="row">     <div class="col-xs-12">      {% if(data[key][val] == 0 ){ %}          <input class ="attribute_value" id="{%= val %}" type="checkbox" name="attribute_val"          data-att= "{%= val %}" data-attr-val="{%= key %}" value="{%= val %}">          {%= val %}        {% } %}        {% if(data[key][val] != 0 ){ %}          <input class ="attribute_value" id="{%= val %}" type="checkbox" name="attribute_val"          data-att= "{%= val %}" data-attr-val="{%= key %}" value="{%= val %}" checked="checked">          {%= val %}        {% } %}        </div>    </div>   {% } %}   <br>  {% } %} </div>';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/templates/sub_sub_family.html
 */
frappe.templates['sub_sub_family'] = '<div class="container" style="margin-top:18px;">  {% for(var key in data){ %}   <div class="row">    <div class="col-xs-12" id="{%= key %}">     {%= key %}    </div>       </div>    {% for(var val in data[key]) { %}    <div class="row">     <div class="col-xs-12">      {% if(data[key][val] == 0 ){ %}          <input class ="attribute_value" id="{%= val %}" type="checkbox" name="attribute_val"          data-att= "{%= val %}" data-attr-val="{%= key %}" value="{%= val %}">          {%= val %}        {% } %}        {% if(data[key][val] != 0 ){ %}          <input class ="attribute_value" id="{%= val %}" type="checkbox" name="attribute_val"          data-att= "{%= val %}" data-attr-val="{%= key %}" value="{%= val %}" checked="checked">          {%= val %}        {% } %}        </div>    </div>   {% } %}   <br>  {% } %} </div>';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/web_pages/get_products.html
 */
frappe.templates['get_products'] = '';

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/js/google.js
 */

/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/js/leaflet.js
 */
/*
...
/*
 *	/home/indictrans/pooja_workspace/artyfetes_v10/frappe-bench/apps/artyfetes/artyfetes/public/js/map.js
 */
function initMap() {
